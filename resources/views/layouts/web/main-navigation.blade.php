      ...
      <ul class="navbar-nav d-none d-lg-block">
        <li class="nav-item dropdown-toggle {{ active('investigacion') }} {{ active('investigacion/*') }}">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown-item {{ active('investigacion/grupos-investigacion') }}">
              <a href="{{ route('web.grupos-investigacion') }}">Grupos de Investigación</a>
            </li>

            <li class="dropdown-item {{ active('investigacion/semilleros-investigacion') }}">
              <a href="{{ route('web.semilleros-investigacion') }}">Semilleros de Investigacion</a>
            </li>
