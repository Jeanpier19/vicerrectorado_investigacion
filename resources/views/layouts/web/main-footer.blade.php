    ...
    <div class="row pb-3">
      <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12">
        ...
        <ul class="information-list">
          ...
          @if($descripcion->telefono_2)<li><a href="tel:{{ $descripcion->telefono_2 }}"><i class="fe-icon-phone"></i>&nbsp;{{ $descripcion->telefono_2 }} Anexo {{ $descripcion->anexo_2 }}</a></li>@endif
          @if($descripcion->telefono_3)<li><a href="tel:{{ $descripcion->telefono_3 }}"><i class="fe-icon-phone"></i>&nbsp;{{ $descripcion->telefono_3 }} Anexo {{ $descripcion->anexo_3 }}</a></li>@endif
        ...
        <div class="row">
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            ...
            <ul class="m-0">
              ...
              <li class="mb-1"><a href="{{ route('web.plataforma-unica-investigacion') }}">Plataforma Única de Investigación</a></li>
            </ul>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            ...
            <ul class="m-0">
              ...
              <li class="mb-1"><a href="{{ route('web.proyectos-investigacion') }}">Proyectos de Investigación</a></li>
              {{-- <li class="mb-1"><a href="{{ route('web.publicaciones-cientificas-indizadas') }}">Publicaciones Científicas Indizadas</a></li> --}}
              <li class="mb-1"><a href="{{ route('web.selasi') }}">SELASI</a></li>
              @foreach($tipos_publicacion as $tipo_publicacion)
              <li class="mb-1"><a href="{{ route('web.publicaciones', $tipo_publicacion->slug) }}">{{ $tipo_publicacion->nombre }}</a></li>
              @endforeach
            </ul>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            ...
            <ul class="m-0">
              ...
              <li class="mb-1"><a href="{{ route('web.proyectos-emprendimiento') }}">Emprendimientos UNASAM</a></li>
