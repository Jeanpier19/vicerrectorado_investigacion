              ...
              <table class="table table-striped" id="table">
                ...
                <tbody>
                  ...
                  <tr v-for="item, key in items">
                    ...
                    {{-- <td>
                      <ul class="p-0">
                        <li v-for="item, key in item.linea">@{{ item.nombre }}
                          <div class="card">
                            <div class="card-header">Líneas de Investigación</div>
                            <div class="card-body p-2">
                              <ul class="list-group">
                                <li class="list-group-item" v-for="item in item.linea">N° @{{ item.numero }}.- @{{ item.nombre }}</li>
                              </ul>
                            </div>
                          </div>
                        </li>
...
@endsection
@section('custom_js')
  @include('web.vue.grupos-investigacion')
@endsection