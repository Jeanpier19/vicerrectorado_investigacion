                    ...
                    <aside class="offcanvas-container" id="filters">
                        <div class="offcanvas-scrollable-area px-4 pt-5 px-lg-0 pt-lg-0"><span class="offcanvas-close"><i
                            ...
                            <div class="widget">
                                ...
                                <select class="form-control mb-3" id="tosearch_tipo" v-model="tosearch_tipo"
                                    @change="searchItems(); tosearch_facultad = []; tosearch_tipo_convenio_especifico = []">
                            ...
                            <div class="widget" v-show="tosearch_tipo == 1">
                                ...
                                <div class="custom-control custom-checkbox" v-for="item in tipos_convenio_especifico">
                                    <input class="custom-control-input" type="checkbox"
                                        :id="'TipoConvenioEspecifico' + item.id" :value="item.id"
                                        v-model="tosearch_tipo_convenio_especifico" @change="searchItems()">
                                    <label class="custom-control-label"
                                        :for="'TipoConvenioEspecifico' + item.id">@{{ item.nombre }}</label>
                                </div>
                            </div>
                        </div>
                    </aside>
              ...
              =================================-->
                    ...
                    <div class="table-responsive" v-show="!loader">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="11" class="text-center" v-if="items.length == 0">No se encontraron
                                        registros coincidentes</td>
                                </tr>
                                <tr v-for="item in items">
                                    <td v-text="item.tipo == 1 ? 'Específico' : 'Marco'"></td>
                                    <td><img :src="item.institucion && item.institucion.logos ? `/archivos/imagenes/instituciones/${item.institucion.logos}` :
                                      '/archivos/imagenes/Universidad.svg'"
                                          alt="Logo" style="width: 50px; height: 50px; object-fit: contain;"></td>
                                    ...
                                    <td>
                                        ...
                                        <template v-for="temp in item.files ">
                                            <a v-bind:href="getPDF(temp.path)" target="_blank"
                                                class="btn btn-danger btn-sm" data-placement="top" data-toggle="tooltip"
                                                title="Ver Documento" style="margin: 5px;">
