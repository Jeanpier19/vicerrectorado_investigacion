          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                <a href="{{ asset('archivos/imagenes/usuario-masculino.jpg') }}" class="fancybox" data-fancybox="Direccion" data-caption="HUGO WALTER MALDONADO LEYVA (Unidad de Investigación e Innovación UII)">
                  <img src="{{ asset('archivos/imagenes/uii.jpg') }}" class="img-fluid" alt="">
                </a>
              </div>
      ...
      <div class="col-lg-6 col-sm-12 mb-5 wow fadeInUp">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                <a href="{{ asset('archivos/imagenes/uct.jpg') }}" class="fancybox" data-fancybox="Direccion" data-caption="EDWIN JULIO PALOMINO CADENAS (Unidad de Cooperación Técnica UCT)">
                  <img src="{{ asset('archivos/imagenes/uct.jpg') }}" class="img-fluid" alt="">
                </a>
              </div>
              <div class="col-lg-8 col-md-8 col-sm-12 text-center text-lg-left text-md-left">
