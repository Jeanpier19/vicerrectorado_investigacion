;(function ($) {
  ...
  var theme = {
    ...
    stickyNavbar: function (t, a) {
      if(400, $(t = ".navbar-sticky").length) {
        var e = $(t).outerHeight();
        $(WINDOW).on("scroll", function() {
          400 < $(this).scrollTop() ? ($(t).addClass("navbar-stuck"),
            $(t).hasClass("navbar-floating") || $(BODY).css("padding-top",e)) : ($(t).removeClass("navbar-stuck"),
    ...
    */
    searchAutocomplete: function (selector) {
      ...
      var options = {
        url: '/archivos/search/search-autocomplete.json',
        getValue: 'name',
        list: {
          match: {
            enabled: true
