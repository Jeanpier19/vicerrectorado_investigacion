        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-sm-12">
            <div class="input-group mb-2">
              ...
              <button type="button" class="btn btn-success ml-1" @click.prevent="openModalCreate()"><i class="fas fa-fw fa-plus-circle"></i>&nbsp;Registrar Institución</button>
            </div>
          </div>
        </div>
              ...
              <div class="modal-body">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-5">
                    ...
                    <select v-model="form.tipo_institucion_id" type="text" name="tipo_institucion_id" id="tipo_institucion_id"
                    class="form-control" :class="{ 'is-invalid': form.errors.has('tipo_institucion_id') }">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      create() {
        this.isLoading = true;
        this.form.post('/api/institucion').then(response => {
