...
<?php $__env->startSection('title', 'Investigadores de la UNASAM | '); ?>
<?php $__env->startSection('content'); ?>
  <div class="page-title d-flex mb-3 wow fadeIn" aria-label="Título" style="background-image: url(/archivos/imagenes/bg-page-title.jpg);">
    <div class="container text-left align-self-center">
      ...
      <div><a href="<?php echo e(route('web.requisitos-deberes-derechos')); ?>" class="btn btn-sm btn-style-4 btn-info"><i class="fe-icon-user-plus"></i> Solicitud para creación de cuenta</a></div>
    </div>
  </div>
...
<?php $__env->startSection('custom_js'); ?>
  <?php echo $__env->make('web.vue.investigadores', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\1. Tecnología Web\Proyecto\SEMANA IX\AppVRI\appVRI\resources\views/web/investigadores.blade.php ENDPATH**/ ?>