  ...
  let main = new Vue({
    ...
    methods: {
      getItems: function(page) {
        ...
        this.loader = true;
        var url = '/axios/vue/proyectos-emprendimiento/get-items?page=' + page + '&search=' + this.search + '&qty_toshow=' + this.qty_toshow + '&tosearch_anio_desde=' + this.tosearch_anio_desde + '&tosearch_anio_hasta=' + this.tosearch_anio_hasta + '&tosearch_facultad=' + JSON.stringify(this.tosearch_facultad) + '&tosearch_tipo_financiacion=' + JSON.stringify(this.tosearch_tipo_financiacion);
...
</script><?php /**PATH /var/www/appVRI/resources/views/web/vue/proyectos-emprendimiento.blade.php ENDPATH**/ ?>