...
<?php $__env->startSection('title', 'Vicerrectorado de Investigación | '); ?>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-12 text-center wow fadeInUp">
        <div class="card">
          <div class="card-body">
            <figure>
              <a href="<?php echo e(asset('archivos/imagenes/vicerector-investigacion.png')); ?>" class="fancybox" data-fancybox="VicerrectorInvestigacion" data-caption="Dr. José Ramiréz Maldonado">
                <img src="<?php echo e(asset('archivos/imagenes/vicerector-investigacion.png')); ?>" class="img-fluid" alt="Vicerrectorado de Investigación">
              </a>
            </figure>
          </div>
...
<?php echo $__env->make('layouts.web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/appVRI/resources/views/web/vicerrectorado-investigacion.blade.php ENDPATH**/ ?>